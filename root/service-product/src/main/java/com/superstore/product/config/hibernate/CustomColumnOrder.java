package com.superstore.product.config.hibernate;
    ...
    public List<Column> orderTableColumns(Table table, Metadata metadata) {
        ...
        if (entityClass != null) {
            ...
            columns.sort((col1, col2) -> {
                // 1. Primary Key Check : force PKs to the top.
                ...
                // 2. Entity Field Order Check (fallback if both are PKs or both are regular columns).
