package com.superstore.product.config.redis;
...
public class RedisCacheConfig implements CachingConfigurer {
    ...
    public SessionRepository<?> sessionRepository() {
        ...
        if (checkRedisConnection()) {
            ...
            // "\xac\xed\x00\x05t\x00<spring:session:sessions:cc85cead-7ac2-402f-b68d-d4dbc71725ad"
            // "spring:session:sessions:cc85cead-7ac2-402f-b68d-d4dbc71725ad"
            // FIX : the key serializer.
            template.setKeySerializer(new StringRedisSerializer());
            template.setHashKeySerializer(new StringRedisSerializer());

            // FIX : keep values as JSON.
    ...
    public RedisCacheManager buildRedisCacheManager(LettuceConnectionFactory factory) {
        ...
        // customCacheConfigurations.put("product", defaultCacheConfig.entryTtl(Duration.ofMinutes(30)));
        ...
        // customCacheConfigurations.put("order-all", cacheConfigFor(OrderPojo.class, Duration.ofMinutes(10)));
    ...
    private <T> RedisCacheConfiguration cacheConfigFor(Class<T> type, Duration ttl) {
        ...
        JacksonJsonRedisSerializer<List<T>> serializer = new JacksonJsonRedisSerializer<>(mapper, javaType);
